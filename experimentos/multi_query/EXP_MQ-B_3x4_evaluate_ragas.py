...
# ==========================================
def run_mode_2():
    archivo_salida = "resultados_ragas_MQ-B3x4.xlsx"
    ...
    # prompt para que el LLM genere 3 versiones de la pregunta
    multiquery_prompt = PromptTemplate(
        ...
        template=(
            ...
            "Proporciona EXACTAMENTE 3 preguntas alternativas, una por línea, "
            "sin numeración, sin explicaciones, sin texto adicional. "
            "Pregunta original: {question}"
        ),
    )

    # configuracion del retriever con k=4 por subquery
