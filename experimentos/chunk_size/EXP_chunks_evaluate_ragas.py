...
# configuraciones
CONFIGS = {
    "A": {"db_name": "andalucia_db_chunk500",  "k": 20},
    "B": {"db_name": "andalucia_db", "k": 10},
    "C": {"db_name": "andalucia_db_chunk2000", "k": 5},
}

# selección de configuración
parser = argparse.ArgumentParser(description="Evaluación RAGAS del bot Andalucía")
...
print(f"\nConfiguración seleccionada: {args.config} | db={DB_NAME} | k={K_VALUE}")
...
# ==========================================
def run_mode_2():
    # nombre del archivo de salida incluye la configuración para identificar el experimento
    archivo_salida = f"resultados_ragas_config{args.config}.xlsx"
